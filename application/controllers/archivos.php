...
//////////// VISTAS ///////////////
    ...
    function equipos_archivos($id_equipo = NULL) //Vista para solicitar un presupuesto.
    {
        ...
        // lionel -> clave agregada para el INSERT en equipos_archivos en caso de que el usuario suba un archivo al storage
        $data['tabla'] = 'equipos_archivos'; 
...
//////////// ACCIONES ///////////////
    ...
    function archivo_guardar()
    {
      ...
      // lionel -> bloque comentado porque la idea es siempre guardar el archivo en el storage interno de esta app
