...
///////////////////////////////////////////////////////////////////////////////////
    ...
    function traerListaMunicipio()
    {

        $this->db->select('P.descrip, P.id, P.zona');
        // $this->db->select('P.descrip, P.id, P.provincia');
        $this->db->from('municipios AS P');
        $this->db->where_in('P.zona', array('PBA','RN'));
        // $this->db->where_in('P.provincia', array(1, 2));
