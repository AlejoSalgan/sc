...
class Flota_model extends CI_Model
{
    ...
    function getAllDelimitedFields($fields) {
        $fields = join(",", $fields);
    ...
    /*
        http://localhost/gestion/api/flota/get_vehiculos?destino[]=1&destino[]=3&mapaEm=1
    */
    function getVehiculosApi($queryParams = array()) //destino 1.- "bajada de memoria"; $mapaEM (Equipos moviles).
    {
        $destino = $queryParams["destino"] ?? null;
        $mapaEM = $queryParams["mapaEm"] ?? null;
