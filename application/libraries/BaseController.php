...
class BaseController extends CI_Controller {
	...
	/**
	 * This function is used to check the webService
	 */

	function call_web_service($ws_key, $query_string = null,$metod="get") {

		if($metod=="get"){

			$webservices = WEBSERVICE[$ws_key][ENVIRONMENT];
			
			if($query_string){
				
				$query_string_encoded = http_build_query($query_string);	 
				
				$webservices .= "?$query_string_encoded";
			}
			
			$response = file_get_contents($webservices);
