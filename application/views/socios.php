                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <?php if (($remito->id_estado == 1 || $remito->id_estado == 2) && ($SOremitos[4] == 1)): ?>
                                  <a class="btn btn-success btn-xs" data-toggle="modal" title="Finalizar" data-target="#modalFinalizar<?= $remito->id;$remito->num_remito; $remito->serie?>"><i class="fa fa-check"></i></i> </a>
                                      <!-- sample modal content -->
