            ...
            <div class="col-md-2">
                <div class="tabbable">
                    <ul class="nav tab-group-vertical nav-stacked" style="background-color: white">
                        ...
                        <li class="tab">
                            <a href="#trazabilidad" data-toggle="tab">Trazabilidad</a>
                        </li>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="municipio" name="municipio">
                                                    <option value="-1">Elija un proyecto </option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="municipio2" name="municipio2"
                                                            ...
                                                            <option value="PBA">Todo PBA</option>
                                                            <?php foreach ($municipios as $municipio): ?>
                                                            <option value="<?=$municipio->id?>"><?=$municipio->descrip?>
                                                            </option>
                                                            <?php endforeach; ?>
...
<div class="tab-pane" id="trazabilidad">
    ...
    <div class="box box-warning">
            <div class="box-header with-border">
                <h3 class="box-title">Trazabilidad por Proyecto</h3>
            </div>

            <form role="form" action="<?=base_url('trazabilidad_reportes_excel')?>" method="post">
                <!-- Ruta provisoria -->
                <div class="box-body">
                    <div class="row">
                        <!-- fechas desde hasta -->
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="fecha_desde8">Fecha Desde</label><br>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                    <input class="form-control" type="text" id="fecha_desde8" name="fecha_desde8" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="fecha_hasta8">Fecha Hasta</label><br>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                    <input class="form-control" type="text" id="fecha_hasta8" name="fecha_hasta8" required>
                                </div>
                            </div>
                        </div>
                    </div><!-- FIN FECHAS -->
...
$('#fecha_desde8').datepicker({
    format: 'yyyy-mm-dd',
    language: 'es',
    startDate: minDate,  // Asegúrate de que minDate esté definido
    endDate: new Date()
});

$('#fecha_hasta8').datepicker({
    format: 'yyyy-mm-dd',
    language: 'es',
    startDate: minDate,  // Asegúrate de que minDate esté definido
    endDate: new Date()
