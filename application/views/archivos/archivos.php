        ...
        <div class="box box-primary">
          ...
          <form action="<?= base_url($guardar)?>" method="POST" enctype="multipart/form-data" name="myForm" data-toggle="validator">
                       ...
                       <label for="label_tipo_documentacion">Tipo</label>
                         <div class="input-group">
                           ...
                           <select class="form-control" name="tipo_documentacion" id="tipo_documentacion" required data-error="Seleccionar una opcion.">
                            ...
                            <option value="7" class="fw-bold bg-danger text-danger" disabled>Acta</option>
                          </select>
                         </div>
            ...
            <div class="box-footer">
              <button type="submit" class="btn btn-labeled btn-primary" value="Guardar" >
                <span class="btn-label">
                  <i class="fa fa-save"></i>
                </span>Guardar
              </button>
              <a href="<?=base_url("{$cargar}/{$parametro}?pagina_actual={$pagina_actual}&tabla={$tabla}")?>" class="btn btn-labeled btn-success" <?= ($cant_archivos > 0) ? "" : "disabled" ?> disabled>
                <span class="btn-label"><i class="fa fa-upload"></i></span>Cargar Archivos
              </a>
            </div>
