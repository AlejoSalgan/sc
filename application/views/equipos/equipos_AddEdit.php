                                                    ...
                                                    <div class="row">
                                                      <div class="col-md-3">
                                                          <div class="form-group">
                                                              ...
                                                              <input type="integer" class="form-control" id="velocidad_min"  name="velocidad_min" maxlength="3" value="<?php echo $velocidad_min; ?>">
                                                          </div>
                                                      </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="integer" class="form-control" id="ubicacion_velper"  name="ubicacion_velper" maxlength="3" value="<?php echo $ubicacion_velper; ?>">
                                                            </div>
                                                        </div>
