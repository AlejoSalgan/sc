                      ...
                      <?php else: ?>
                        ...
                        <ul class="products-list product-list-in-box" >
                           ...
                           ?>
                              ...
                              <span class="product-description" style="color: #333333"><?=($record->observaciones == NULL) ? "Sin observaciones.": $record->observaciones ;?></span>
                              <span class="product-description" style="color: #333333">
                                <?php //echo ($record->detalle == NULL) ? "Sin detalles.": $record->detalle ;?>
                                <?php if($record->detalle == NULL): ?>
                                  Sin detalles.
                                <?php else: 
                                  // lionel -> modifico el dominio (hardcodeado en db) para que funcione el enlace en gestion y en local
                                  $record->detalle = str_replace("https://sc.cecaitra.com/", base_url(), $record->detalle);
                                  echo $record->detalle;
                                  endif; 
                                ?>               
                              </span>
