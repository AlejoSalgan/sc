        ...
        <div class="box box-primary">
          ...
          <form action="<?= base_url($guardar)?>" method="POST" enctype="multipart/form-data" name="myForm" data-toggle="validator">
            ...
            <div class="box-footer">
              ...
              <a 
                href="<?=base_url("{$cargar}/{$id_orden}?ref={$this->input->get('ref')}&searchText={$this->input->get('searchText')}")?>" class="btn btn-labeled btn-success" <?= ($cant_archivos > 0) ? "" : "disabled" ?> 
                disabled
              >
                  <span class="btn-label">
                      <i class="fa fa-upload"></i>
                  </span>Cargar Archivos
              </a>
            </div>
          </form>
        </div><!-- /.box -->
