      ...
      <aside class="main-sidebar">
        <section class="sidebar">
          <ul class="sidebar-menu">
            <!-- <li> -->
              <!-- <a href="http://ssti.cecaitra.com/" target="_blank"><i class="fa fa-home text-danger"></i> <span class="text-danger">Ingresar al SSTI</span></a> -->
              <!-- <a href="#"><i class="fa fa-home text-danger"></i> <span class="text-danger">Ingresar al SSTI</span></a> -->
            <!-- </li> -->

            <!-- <form action="<?php //echo base_url("detalle_protocolo");?>" method="POST" class="sidebar-form">
              <div class="input-group">
                <input type="text" name="protocolo" class="form-control" placeholder="Buscar Protocolo" maxlength="6" autocomplete="off">
                    <span class="input-group-btn">
                      <button type="submit" name="search"  class="btn btn-flat"><i class="fa fa-search text-danger"></i>
                      </button>
                    </span>
              </div>
            </form> -->
            <?php foreach ($categorias as $categoria): ?>
              <?php 
                $modulos_deshabilitados = ["ACTAS", /* "PROYECTOS",  */"MEMORIAS", "SSTI"/* , "REPORTES" */, "AGENDA"];
                if(in_array($categoria->nombre, $modulos_deshabilitados)) {
                  continue;
                } 
              ?>
