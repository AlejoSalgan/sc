<?php 
// pre($ordenesbInfo);die;

  if (isset($ordenesbInfo)) {
    // Si $ordenesbInfo->id está definido, asignar ese valor
    $ordenesbId = $ordenesbInfo;
  } else {
    // Si no está definido, asignar valores predeterminados
    $ordenesbInfo = (object) [
        'fecha_visita' => "",
        'idproyecto' => "",
        'descripProyecto' => "",
    ...
    $ordenesbId = ""; // También puedes asignar cualquier valor predeterminado para $ordenesbId si es necesario
  }
?>

<div class="content-wrapper">
    <div style="padding: 10px 15px; background-color: white; z-index: 999999; font-size: 16px; font-weight: 500;">
      <?= $tipoItem?> Orden de Bajadas
      <span class="pull-right">
        <a href="<?= base_url(); ?>" class="fa fa-home"> Inicio</a> /
        <a href="<?= base_url('ordenesbListing')?>">Ordenes de Servicios</a> /
        <span class="text-muted"><?= $tipoItem?> Orden de Bajadas</span>
      </span>
    </div>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form role="form" id="addOrdenesb" action="<?= base_url('agregar_editar_ordenes')?>" method="post" role="form">
                        <input type="hidden" class="form-control" id="ordenesbId" name="ordenesbId" value="<?= $ordenesbId ?>" >
                          ...
                          <div class="row">
                             ...
                             <div class="col-md-6">
                                 <div class="form-group">
                                     ...
                                     <?php else: ?>
                                       <input type="text" id="search_data" class="form-control search-input" name="search-term" value="<?= $ordenesbInfo->idequipo ?>" onkeyup="liveSearch()" autocomplete="off" readonly>
                                       <div id="suggestions">
                                           <div id="autoSuggestionsList">
                                           </div>
                                       </div>
                                       <input type="hidden" name="idequipo" id="idequipo" value="<?= $ordenesbInfo->idequipo ?>" />
                                     <?php endif; ?>
                                 </div>
                             </div>
                          </div>
